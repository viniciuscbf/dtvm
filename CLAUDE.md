...
└─ piloto/
   ...
   ├─ admin/ (23) gestor/ (23) cotista/ (4) custodia/ (6) simulador/ (3)   # portais
...
- **Cadeia de carregamento:** toda página faz `define('BASE_URL','../'); require config/db.php; require includes/auth.php; require includes/layout.php`. `layout.php`→`helpers.php`→`dominio.php`. No **fim** de `dominio.php` há `require` de: `marcacao.php`, `derivativos.php`, `fip.php`, `equipe.php`, `batch.php`, `regulamento.php`.
